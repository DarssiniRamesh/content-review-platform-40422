...
export default function Indice() {
  /** Índice de prototipos screen. Pixel-accurate structure and accessibility per Figma 41:135. */
  useEffect(() => {
    // Decorative SVG accessibility tweaks
    ...
    <main id="canvas" role="main" aria-label="Índice de prototipos">
      ...
      <section className="section section--proto" aria-labelledby="sec-1-title">
        ...
        <div className="cta-group" role="group" aria-label="Prototipo 1 - Inicio">
          <button type="button" className="cta-frame" aria-describedby="cta1-desc" onClick={()=>{ window.location.href = '/instrucciones'; }}>
      ...
      <section className="section section--proto" aria-labelledby="sec-2-title">
        ...
        <div className="cta-group" role="group" aria-label="Prototipo 2 - Inicio">
          <button type="button" className="cta-frame" aria-describedby="cta2-desc" onClick={()=>{ window.location.href = '/instrucciones'; }}>
      ...
      <section className="section section--proto" aria-labelledby="sec-3-title">
        ...
        <div className="cta-group" role="group" aria-label="Prototipo 3 - Inicio">
          <button type="button" className="cta-frame" aria-describedby="cta3-desc" onClick={()=>{ window.location.href = '/instrucciones'; }}>
